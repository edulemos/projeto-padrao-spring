...
insert into TB_PERFIL (ID, NOME) values (1, 'ADMINISTRADOR DO SISTEMA');
insert into TB_PERFIL (ID, NOME) values (2, 'USUARIO DO SISTEMA');
...
select u.name nome, p.nome perfis_associados
